...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!agreedToTerms) {
      alert('Вы должны согласиться с условиями и политикой конфиденциальности');
      return;
    }
    ...
    alert('Функциональность регистрации будет реализована здесь');
  };
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-12 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center">
            <span className="text-indigo-600 dark:text-indigo-400 text-2xl font-bold">T</span>
          </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="terms-and-privacy" className="ml-2 block text-sm text-gray-900 dark:text-white">
              Я согласен с <Link href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">Условиями</Link> и <Link href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">Политикой конфиденциальности</Link>
            </label>
          </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <div>
              <Link href="#" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">
                <span className="sr-only">Зарегистрироваться через Facebook</span>
            ...
            <div>
              <Link href="#" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">
                <span className="sr-only">Зарегистрироваться через Twitter</span>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            ...
            <div>
              <Link href="#" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">
                <span className="sr-only">Зарегистрироваться через Google</span>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
